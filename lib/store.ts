...
function phone(): string {
  return `010-${int(1000, 9999)}-${int(1000, 9999)}`
}
...
const NAMES = [
  '김민준', '이서연', '박도윤', '최지우', '정하은', '강시우', '조유진', '윤준서',
  '장은우', '임채원', '한지호', '오세아', '서예린', '신동현', '권나윤', '황선우',
  '안수빈', '송재원', '전소율', '홍지원', '문지안', '양하율', '배건우', '백서현',
  '유주안', '남기훈', '심아린', '노윤아', '고태오', '하지민',
]
const INDUSTRIES = [
